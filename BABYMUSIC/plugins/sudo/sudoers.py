...
from BABYMUSIC.utils.database import add_sudo, remove_sudo
...
async def check_sudo_list(client, callback_query: CallbackQuery):
    ...
    if callback_query.from_user.id not in SUDOERS:
        return await callback_query.answer("❍ Rudra ᴋᴀ ʟᴜɴᴅ ᴅᴇᴋʜᴇɢᴀ ᴀᴘɴɪ ʙᴇʜᴀɴ ᴋᴏ ᴅᴇ ᴅᴇɴᴀ 🤪 ●", show_alert=True)
    else:
